...
#### Python
1. [comfyanonymous/ComfyUI (44,420s/4,718f)](https://github.com/comfyanonymous/ComfyUI) : The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
2. [yt-dlp/yt-dlp (78,748s/6,184f)](https://github.com/yt-dlp/yt-dlp) : A feature-rich command-line audio/video downloader
...
4. [pytorch/torchchat (2,313s/160f)](https://github.com/pytorch/torchchat) : Run PyTorch LLMs locally on servers, desktop and mobile
...
6. [AUTOMATIC1111/stable-diffusion-webui (137,289s/26,135f)](https://github.com/AUTOMATIC1111/stable-diffusion-webui) : Stable Diffusion web UI
7. [Asabeneh/30-Days-Of-Python (39,692s/7,590f)](https://github.com/Asabeneh/30-Days-Of-Python) : 30 days of Python programming challenge is a step-by-step guide to learn the Python programming language in 30 days. This challenge may take more than100 days, follow your own pace. These videos may help too: https://www.youtube.com/channel/UC7PNRuno1rzYPb1xLa4yktw
...
12. [myshell-ai/OpenVoice (27,784s/2,708f)](https://github.com/myshell-ai/OpenVoice) : Instant voice cloning by MyShell.
...
14. [InternLM/lagent (1,252s/126f)](https://github.com/InternLM/lagent) : A lightweight framework for building LLM-based agents
...
17. [donnemartin/system-design-primer (266,038s/45,073f)](https://github.com/donnemartin/system-design-primer) : Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
...
15. [xpipe-io/xpipe (2,531s/72f)](https://github.com/xpipe-io/xpipe) : Your entire server infrastructure at your fingertips
...
#### Go
1. [xvzc/SpoofDPI (1,196s/74f)](https://github.com/xvzc/SpoofDPI) : A simple and fast anti-censorship tool written in Go
2. [pocketbase/pocketbase (37,546s/1,683f)](https://github.com/pocketbase/pocketbase) : Open Source realtime backend in 1 file
3. [XTLS/Xray-core (23,393s/3,734f)](https://github.com/XTLS/Xray-core) : Xray, Penetrates Everything. Also the best v2ray-core, with XTLS support. Fully compatible configuration.
...
13. [ethereum/go-ethereum (47,191s/20,097f)](https://github.com/ethereum/go-ethereum) : Go implementation of the Ethereum protocol
...
#### C
1. [ValdikSS/GoodbyeDPI (17,800s/1,380f)](https://github.com/ValdikSS/GoodbyeDPI) : GoodbyeDPI — Deep Packet Inspection circumvention utility (for Windows)
2. [bol-van/zapret (4,052s/416f)](https://github.com/bol-van/zapret) : DPI bypass multi platform
3. [asg017/sqlite-vec (2,375s/78f)](https://github.com/asg017/sqlite-vec) : A vector search SQLite extension that runs anywhere!
...
#### Swift
1. [Dimillian/IceCubesApp (5,089s/474f)](https://github.com/Dimillian/IceCubesApp) : A SwiftUI Mastodon client
...
9. [gedoor/legado (26,967s/3,684f)](https://github.com/gedoor/legado) : Legado 3.0 Book Reader with powerful controls & full functions❤️阅读3.0, 阅读是一款可以自定义来源阅读网络内容的工具，为广大网络文学爱好者提供一种方便、快捷舒适的试读体验。
...
#### TypeScript
1. [immich-app/immich (41,513s/2,042f)](https://github.com/immich-app/immich) : High performance self-hosted photo and video management solution.
...
9. [RSSNext/follow (2,595s/71f)](https://github.com/RSSNext/follow) : 🧡 Next generation information browser
...
#### JavaScript
1. [SuhailTechInfo/Suhail-Md (4,736s/15,796f)](https://github.com/SuhailTechInfo/Suhail-Md) : meet Suhail-Md, Your All-in-One WhatsApp Excitement Buddy! Enjoy a thrilling messaging experience like never before. Suhail-Md brings a world of excitement and joy to your chats ✨🤖
...
14. [academicpages/academicpages.github.io (11,260s/40,639f)](https://github.com/academicpages/academicpages.github.io) : Github Pages template for academic personal websites, forked from mmistakes/minimal-mistakes
...
#### Vue
1. [vbenjs/vue-vben-admin (23,377s/6,383f)](https://github.com/vbenjs/vue-vben-admin) : A modern vue admin. It is based on Vue3、Shadcn UI、vite and TypeScript. It's fast！
...
9. [jaywcjlove/linux-command (30,548s/5,941f)](https://github.com/jaywcjlove/linux-command) : Linux命令大全搜索工具，内容包含Linux命令手册、详解、学习、搜集。https://git.io/linux
...
13. [Evavic44/portfolio-ideas (3,973s/582f)](https://github.com/Evavic44/portfolio-ideas) : A curation of awesome portfolio website ideas for developers and designers to draw inspiration from. Raise a pull request to add more. 💜
14. [KaiserY/trpl-zh-cn (4,394s/575f)](https://github.com/KaiserY/trpl-zh-cn) : Rust 程序设计语言（2021 edition）
15. [labuladong/fucking-algorithm (124,528s/23,147f)](https://github.com/labuladong/fucking-algorithm) : 刷算法全靠套路，认准 labuladong 就够了！English version supported! Crack LeetCode, not only how, but also why.
...
11. [chatwoot/chatwoot (19,881s/3,214f)](https://github.com/chatwoot/chatwoot) : Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
12. [kilimchoi/engineering-blogs (30,523s/1,520f)](https://github.com/kilimchoi/engineering-blogs) : A curated list of engineering blogs
13. [gitlabhq/gitlabhq (23,702s/5,723f)](https://github.com/gitlabhq/gitlabhq) : GitLab CE Mirror | Please open new issues in our issue tracker on GitLab.com
14. [cloudfoundry/routing-release (42s/107f)](https://github.com/cloudfoundry/routing-release) : This is the BOSH release for cloud foundry routers
15. [instructure/canvas-lms (5,473s/2,444f)](https://github.com/instructure/canvas-lms) : The open LMS by Instructure, Inc.
