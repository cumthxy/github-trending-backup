...
2. [Homebrew/homebrew-cask (20,732s/10,614f)](https://github.com/Homebrew/homebrew-cask) : 🍻 A CLI workflow for the administration of macOS applications distributed as binaries
3. [maybe-finance/maybe (29,008s/2,201f)](https://github.com/maybe-finance/maybe) : The OS for your personal finances
4. [huginn/huginn (42,487s/3,729f)](https://github.com/huginn/huginn) : Create agents that monitor and act on your behalf. Your agents are standing by!
...
7. [Homebrew/homebrew-core (13,485s/12,236f)](https://github.com/Homebrew/homebrew-core) : 🍻 Default formulae for the missing package manager for macOS (or Linux)
...
9. [ruby/ruby (21,798s/5,295f)](https://github.com/ruby/ruby) : The Ruby Programming Language
10. [basecamp/kamal (9,450s/365f)](https://github.com/basecamp/kamal) : Deploy web apps anywhere.
11. [chef/chef (7,551s/2,510f)](https://github.com/chef/chef) : Chef Infra, a powerful automation platform that transforms infrastructure into code automating how infrastructure is configured, deployed and managed across any environment, at any scale
12. [opf/openproject (8,846s/2,249f)](https://github.com/opf/openproject) : OpenProject is the leading open source project management software.
13. [Homebrew/brew (40,397s/9,465f)](https://github.com/Homebrew/brew) : 🍺 The missing package manager for macOS (or Linux)
14. [forem/forem (21,804s/3,983f)](https://github.com/forem/forem) : For empowering community 🌱
15. [kilimchoi/engineering-blogs (30,523s/1,520f)](https://github.com/kilimchoi/engineering-blogs) : A curated list of engineering blogs
16. [jwt/ruby-jwt (3,576s/374f)](https://github.com/jwt/ruby-jwt) : A ruby implementation of the RFC 7519 OAuth JSON Web Token (JWT) standard.
17. [gitlabhq/gitlabhq (23,702s/5,723f)](https://github.com/gitlabhq/gitlabhq) : GitLab CE Mirror | Please open new issues in our issue tracker on GitLab.com
18. [rubysec/ruby-advisory-db (1,001s/216f)](https://github.com/rubysec/ruby-advisory-db) : A database of vulnerable Ruby Gems

#### Rust
1. [astral-sh/uv (15,659s/465f)](https://github.com/astral-sh/uv) : An extremely fast Python package installer and resolver, written in Rust.
2. [RustPython/RustPython (18,415s/1,215f)](https://github.com/RustPython/RustPython) : A Python Interpreter written in Rust
3. [tracel-ai/burn (8,013s/388f)](https://github.com/tracel-ai/burn) : Burn is a new comprehensive dynamic Deep Learning Framework built using Rust with extreme flexibility, compute efficiency and portability as its primary goals.
4. [tauri-apps/tauri (80,431s/2,399f)](https://github.com/tauri-apps/tauri) : Build smaller, faster, and more secure desktop applications with a web frontend.
5. [sxyazi/yazi (13,280s/306f)](https://github.com/sxyazi/yazi) : 💥 Blazing fast terminal file manager written in Rust, based on async I/O.
6. [gleam-lang/gleam (16,935s/711f)](https://github.com/gleam-lang/gleam) : ⭐️ A friendly language for building type-safe, scalable systems!
7. [alvr-org/ALVR (5,117s/473f)](https://github.com/alvr-org/ALVR) : Stream VR games from your PC to your headset via Wi-Fi
8. [rust-lang/rust (95,648s/12,322f)](https://github.com/rust-lang/rust) : Empowering everyone to build reliable and efficient software.
9. [pola-rs/polars (28,417s/1,777f)](https://github.com/pola-rs/polars) : Dataframes powered by a multithreaded, vectorized query engine, written in Rust
...
11. [helix-editor/helix (32,001s/2,374f)](https://github.com/helix-editor/helix) : A post-modern modal text editor.
12. [Jondolf/avian (1,252s/103f)](https://github.com/Jondolf/avian) : ECS-driven 2D and 3D physics engine for the Bevy game engine.
...
14. [stalwartlabs/mail-server (3,912s/153f)](https://github.com/stalwartlabs/mail-server) : Secure & Modern All-in-One Mail Server (IMAP, JMAP, POP3, SMTP)
...
18. [zed-industries/zed (43,203s/2,304f)](https://github.com/zed-industries/zed) : Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
...
20. [rapiz1/rathole (9,113s/458f)](https://github.com/rapiz1/rathole) : A lightweight and high-performance reverse proxy for NAT traversal, written in Rust. An alternative to frp and ngrok.
...
#### Python
1. [comfyanonymous/ComfyUI (44,407s/4,716f)](https://github.com/comfyanonymous/ComfyUI) : The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
2. [yt-dlp/yt-dlp (78,734s/6,184f)](https://github.com/yt-dlp/yt-dlp) : A feature-rich command-line audio/video downloader
3. [zulip/zulip (20,777s/7,598f)](https://github.com/zulip/zulip) : Zulip server and web application. Open-source team chat that helps teams stay productive and focused.
4. [pytorch/torchchat (2,300s/159f)](https://github.com/pytorch/torchchat) : Run PyTorch LLMs locally on servers, desktop and mobile
...
6. [AUTOMATIC1111/stable-diffusion-webui (137,282s/26,133f)](https://github.com/AUTOMATIC1111/stable-diffusion-webui) : Stable Diffusion web UI
7. [Asabeneh/30-Days-Of-Python (39,690s/7,590f)](https://github.com/Asabeneh/30-Days-Of-Python) : 30 days of Python programming challenge is a step-by-step guide to learn the Python programming language in 30 days. This challenge may take more than100 days, follow your own pace. These videos may help too: https://www.youtube.com/channel/UC7PNRuno1rzYPb1xLa4yktw
8. [mlc-ai/mlc-llm (18,233s/1,443f)](https://github.com/mlc-ai/mlc-llm) : Universal LLM Deployment Engine with ML Compilation
9. [mxrch/GHunt (15,361s/1,274f)](https://github.com/mxrch/GHunt) : 🕵️‍♂️ Offensive Google framework.
10. [swisskyrepo/PayloadsAllTheThings (58,902s/14,296f)](https://github.com/swisskyrepo/PayloadsAllTheThings) : A list of useful payloads and bypass for Web Application Security and Pentest/CTF
11. [frappe/hrms (1,096s/599f)](https://github.com/frappe/hrms) : Open Source HR and Payroll Software
12. [myshell-ai/OpenVoice (27,782s/2,708f)](https://github.com/myshell-ai/OpenVoice) : Instant voice cloning by MyShell.
13. [huggingface/diffusers (24,403s/5,040f)](https://github.com/huggingface/diffusers) : 🤗 Diffusers: State-of-the-art diffusion models for image and audio generation in PyTorch and FLAX.
14. [InternLM/lagent (1,250s/126f)](https://github.com/InternLM/lagent) : A lightweight framework for building LLM-based agents
...
17. [donnemartin/system-design-primer (266,032s/45,073f)](https://github.com/donnemartin/system-design-primer) : Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.

#### Go
1. [xvzc/SpoofDPI (1,190s/73f)](https://github.com/xvzc/SpoofDPI) : A simple and fast anti-censorship tool written in Go
2. [pocketbase/pocketbase (37,544s/1,683f)](https://github.com/pocketbase/pocketbase) : Open Source realtime backend in 1 file
...
5. [wailsapp/wails (23,761s/1,134f)](https://github.com/wailsapp/wails) : Create beautiful applications using Go
...
7. [photoprism/photoprism (33,949s/1,862f)](https://github.com/photoprism/photoprism) : AI-Powered Photos App for the Decentralized Web 🌈💎✨
...
11. [tailscale/tailscale (17,986s/1,385f)](https://github.com/tailscale/tailscale) : The easiest, most secure way to use WireGuard and 2FA.
12. [v2fly/v2ray-core (28,573s/4,559f)](https://github.com/v2fly/v2ray-core) : A platform for building proxies to bypass network restrictions.
13. [ethereum/go-ethereum (47,189s/20,097f)](https://github.com/ethereum/go-ethereum) : Go implementation of the Ethereum protocol
...
17. [filebrowser/filebrowser (25,146s/2,882f)](https://github.com/filebrowser/filebrowser) : 📂 Web File Browser
...
21. [alist-org/alist (40,693s/5,269f)](https://github.com/alist-org/alist) : 🗂️A file list/WebDAV program that supports multiple storages, powered by Gin and Solidjs. / 一个支持多存储的文件列表/WebDAV程序，使用 Gin 和 Solidjs。
...
23. [projectdiscovery/nuclei (18,886s/2,374f)](https://github.com/projectdiscovery/nuclei) : Fast and customizable vulnerability scanner based on simple YAML based DSL.

#### Java
1. [jagrosh/MusicBot (4,975s/2,468f)](https://github.com/jagrosh/MusicBot) : 🎶 A Discord music bot that's easy to set up and run yourself!
2. [termux/termux-app (33,660s/3,553f)](https://github.com/termux/termux-app) : Termux - a terminal emulator application for Android OS extendible by variety of packages.
...
6. [doocs/leetcode (30,196s/6,092f)](https://github.com/doocs/leetcode) : 🔥LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
...
9. [Netflix/maestro (2,675s/163f)](https://github.com/Netflix/maestro) : Maestro: Netflix’s Workflow Orchestrator
10. [spring-projects/spring-framework (55,848s/37,860f)](https://github.com/spring-projects/spring-framework) : Spring Framework
...
14. [xiaojieonly/Ehviewer_CN_SXJ (12,480s/374f)](https://github.com/xiaojieonly/Ehviewer_CN_SXJ) : ehviewer，用爱发电，快乐前行
...
20. [Grasscutters/Grasscutter (16,053s/4,471f)](https://github.com/Grasscutters/Grasscutter) : A server software reimplementation for a certain anime game.
...
4. [objective-see/LuLu (9,519s/443f)](https://github.com/objective-see/LuLu) : LuLu is the free macOS firewall
...
5. [PlayCover/PlayCover (8,048s/751f)](https://github.com/PlayCover/PlayCover) : Community fork of PlayCover
6. [MrKai77/Loop (5,814s/114f)](https://github.com/MrKai77/Loop) : Window management made elegant.
7. [pointfreeco/swift-composable-architecture (11,994s/1,415f)](https://github.com/pointfreeco/swift-composable-architecture) : A library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
12. [iina/iina (37,328s/2,540f)](https://github.com/iina/iina) : The modern video player for macOS.
...
17. [SwiftyJSON/SwiftyJSON (22,544s/3,420f)](https://github.com/SwiftyJSON/SwiftyJSON) : The better way to deal with JSON data in Swift.
...
#### Kotlin
1. [RikkaApps/Shizuku (9,434s/562f)](https://github.com/RikkaApps/Shizuku) : Using system APIs directly with adb/root privileges from normal apps through a Java process started with app_process.
2. [gkd-kit/gkd (18,371s/966f)](https://github.com/gkd-kit/gkd) : 基于无障碍，高级选择器，订阅规则的自定义屏幕点击 Android 应用 | An Android APP with custom screen tapping based on Accessibility, Advanced Selectors, and Subscription Rules
3. [deniscerri/ytdlnis (3,317s/117f)](https://github.com/deniscerri/ytdlnis) : Android Video/Audio Downloader app using yt-dlp
4. [MatsuriDayo/NekoBoxForAndroid (10,134s/874f)](https://github.com/MatsuriDayo/NekoBoxForAndroid) : NekoBox for Android / sing-box / universal proxy toolchain for Android
5. [Ivy-Apps/ivy-wallet (2,546s/588f)](https://github.com/Ivy-Apps/ivy-wallet) : Ivy Wallet is an open-source money manager app for android that you can either build or download from Google Play.
6. [pppscn/SmsForwarder (16,532s/2,250f)](https://github.com/pppscn/SmsForwarder) : 短信转发器——监控Android手机短信、来电、APP通知，并根据指定规则转发到其他手机：钉钉群自定义机器人、钉钉企业内机器人、企业微信群机器人、飞书机器人、企业微信应用消息、邮箱、bark、webhook、Telegram机器人、Server酱、PushPlus、手机短信等。包括主动控制服务端与客户端，让你轻松远程发短信、查短信、查通话、查话簿、查电量等。（V3.0 新增）PS.这个APK主要是学习与自用，如有BUG请提ISSUE，同时欢迎大家提PR指正
...
8. [2dust/v2rayNG (33,414s/5,222f)](https://github.com/2dust/v2rayNG) : A V2Ray client for Android, support Xray core and v2fly core
9. [gedoor/legado (26,963s/3,684f)](https://github.com/gedoor/legado) : Legado 3.0 Book Reader with powerful controls & full functions❤️阅读3.0, 阅读是一款可以自定义来源阅读网络内容的工具，为广大网络文学爱好者提供一种方便、快捷舒适的试读体验。
...
11. [Nain57/Smart-AutoClicker (1,549s/295f)](https://github.com/Nain57/Smart-AutoClicker) : An open-source auto clicker on images for Android
...
14. [android/architecture-samples (44,176s/11,600f)](https://github.com/android/architecture-samples) : A collection of samples to discuss and showcase different architectural tools and patterns for Android apps.
...
#### HTML
1. [comfyanonymous/ComfyUI_examples (1,425s/164f)](https://github.com/comfyanonymous/ComfyUI_examples) : Examples of ComfyUI workflows
...
5. [leaningtech/webvm (4,153s/659f)](https://github.com/leaningtech/webvm) : Virtual Machine for the Web
...
9. [wesbos/JavaScript30 (27,348s/37,313f)](https://github.com/wesbos/JavaScript30) : 30 Day Vanilla JS Challenge
10. [TandoorRecipes/recipes (5,204s/552f)](https://github.com/TandoorRecipes/recipes) : Application for managing recipes, planning meals, building shopping lists and much much more!
11. [alshedivat/al-folio (10,147s/10,797f)](https://github.com/alshedivat/al-folio) : A beautiful, simple, clean, and responsive Jekyll theme for academics
...
15. [cotes2020/jekyll-theme-chirpy (6,882s/5,524f)](https://github.com/cotes2020/jekyll-theme-chirpy) : A minimal, responsive, and feature-rich Jekyll theme for technical writing.

#### C
1. [ValdikSS/GoodbyeDPI (17,768s/1,374f)](https://github.com/ValdikSS/GoodbyeDPI) : GoodbyeDPI — Deep Packet Inspection circumvention utility (for Windows)
2. [bol-van/zapret (4,046s/414f)](https://github.com/bol-van/zapret) : DPI bypass multi platform
3. [asg017/sqlite-vec (2,357s/78f)](https://github.com/asg017/sqlite-vec) : A vector search SQLite extension that runs anywhere!
4. [hufrea/byedpi (529s/47f)](https://github.com/hufrea/byedpi) : Bypass DPI
5. [c3lang/c3c (2,107s/107f)](https://github.com/c3lang/c3c) : Compiler for the C3 language
6. [Genymobile/scrcpy (106,810s/10,331f)](https://github.com/Genymobile/scrcpy) : Display and control your Android device
...
17. [mpv-player/mpv (26,999s/2,847f)](https://github.com/mpv-player/mpv) : 🎥 Command line video player
...
21. [netdata/netdata (69,874s/5,826f)](https://github.com/netdata/netdata) : The open-source observability platform everyone needs!
...
#### JavaScript
1. [SuhailTechInfo/Suhail-Md (4,734s/15,793f)](https://github.com/SuhailTechInfo/Suhail-Md) : meet Suhail-Md, Your All-in-One WhatsApp Excitement Buddy! Enjoy a thrilling messaging experience like never before. Suhail-Md brings a world of excitement and joy to your chats ✨🤖
2. [blackmatrix7/ios_rule_script (16,774s/2,697f)](https://github.com/blackmatrix7/ios_rule_script) : 分流规则、重写写规则及脚本。
3. [facebook/react (225,955s/46,099f)](https://github.com/facebook/react) : The library for web and native user interfaces.
4. [iptv-org/iptv (82,913s/2,270f)](https://github.com/iptv-org/iptv) : Collection of publicly available IPTV channels from all over the world
...
6. [schlagmichdoch/PairDrop (4,001s/225f)](https://github.com/schlagmichdoch/PairDrop) : PairDrop: Local file sharing in your browser. Inspired by Apple's AirDrop. Fork of Snapdrop.
7. [bigskysoftware/htmx (36,051s/1,220f)](https://github.com/bigskysoftware/htmx) : </> htmx - high power tools for HTML
8. [Asabeneh/30-Days-Of-JavaScript (42,080s/9,769f)](https://github.com/Asabeneh/30-Days-Of-JavaScript) : 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace. These videos may help too: https://www.youtube.com/channel/UC7PNRuno1rzYPb1xLa4yktw
9. [prabathLK/PRABATH-MD (1,309s/5,079f)](https://github.com/prabathLK/PRABATH-MD) : 🇱🇰 Multi-device whatsapp bot 🎉
10. [louislam/uptime-kuma (53,824s/4,854f)](https://github.com/louislam/uptime-kuma) : A fancy self-hosted monitoring tool
...
12. [Kong/insomnia (33,930s/1,902f)](https://github.com/Kong/insomnia) : The open-source, cross-platform API client for GraphQL, REST, WebSockets, SSE and gRPC. With Cloud, Local and Git storage.
...
14. [academicpages/academicpages.github.io (11,259s/40,638f)](https://github.com/academicpages/academicpages.github.io) : Github Pages template for academic personal websites, forked from mmistakes/minimal-mistakes
...
#### Vue
1. [vbenjs/vue-vben-admin (23,369s/6,381f)](https://github.com/vbenjs/vue-vben-admin) : A modern vue admin. It is based on Vue3、Shadcn UI、vite and TypeScript. It's fast！
...
3. [HalseySpicy/Geeker-Admin (6,916s/1,450f)](https://github.com/HalseySpicy/Geeker-Admin) : ✨✨✨ Geeker Admin，基于 Vue3.4、TypeScript、Vite5、Pinia、Element-Plus 开源的一套后台管理框架。
4. [CorentinTh/it-tools (19,222s/2,323f)](https://github.com/CorentinTh/it-tools) : Collection of handy online tools for developers, with great UX.
5. [Hunlongyu/ZY-Player (14,015s/2,237f)](https://github.com/Hunlongyu/ZY-Player) : ▶️ 跨平台桌面端视频资源播放器.简洁无广告.免费高颜值. 🎞
...
9. [primefaces/primevue (9,251s/1,124f)](https://github.com/primefaces/primevue) : Next Generation Vue UI Component Library
10. [wanglin2/mind-map (5,002s/728f)](https://github.com/wanglin2/mind-map) : 一个还算强大的Web思维导图。A relatively powerful web mind map.
11. [Lissy93/dashy (16,513s/1,259f)](https://github.com/Lissy93/dashy) : 🚀 A self-hostable personal dashboard built for you. Includes status-checking, widgets, themes, icon packs, a UI editor and tons more!
...
14. [doocs/md (5,248s/836f)](https://github.com/doocs/md) : ✍ WeChat Markdown Editor | 一款高度简洁的微信 Markdown 编辑器：支持 Markdown 语法、色盘取色、多图上传、一键下载文档、自定义 CSS 样式、一键重置等特性
...
16. [imsyy/home (2,956s/1,772f)](https://github.com/imsyy/home) : 个人主页，我的个人主页，个人主页源码，主页模板，homepage
...
#### TypeScript
1. [immich-app/immich (41,511s/2,041f)](https://github.com/immich-app/immich) : High performance self-hosted photo and video management solution.
2. [miurla/morphic (5,316s/1,282f)](https://github.com/miurla/morphic) : An AI-powered search engine with a generative UI
3. [adrianhajdin/banking (1,325s/399f)](https://github.com/adrianhajdin/banking) : Horizon is a modern banking platform for everyone.
4. [actualbudget/actual (12,992s/1,020f)](https://github.com/actualbudget/actual) : A local-first personal finance app
5. [home-assistant/frontend (3,848s/2,623f)](https://github.com/home-assistant/frontend) : 🍭 Frontend for Home Assistant
...
9. [RSSNext/follow (2,589s/70f)](https://github.com/RSSNext/follow) : 🧡 Next generation information browser
10. [kamranahmedse/developer-roadmap (285,164s/37,924f)](https://github.com/kamranahmedse/developer-roadmap) : Interactive roadmaps, guides and other educational content to help developers grow in their careers.
...
12. [electron-userland/electron-builder (13,507s/1,725f)](https://github.com/electron-userland/electron-builder) : A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box
...
14. [calcom/cal.com (30,355s/7,239f)](https://github.com/calcom/cal.com) : Scheduling infrastructure for absolutely everyone.
...
#### TeX
1. [zhanwen/MathModel (7,663s/2,064f)](https://github.com/zhanwen/MathModel) : 研究生数学建模，本科生数学建模、数学建模竞赛优秀论文，数学建模算法，LaTeX论文模板，算法思维导图，参考书籍，Matlab软件教程，PPT
...
#### Shell
1. [juewuy/ShellCrash (7,984s/1,365f)](https://github.com/juewuy/ShellCrash) : Run sing-box/mihomo as client in shell
...
3. [youngyangyang04/leetcode-master (49,563s/11,162f)](https://github.com/youngyangyang04/leetcode-master) : 《代码随想录》LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，支持C++，Java，Python，Go，JavaScript等多语言版本，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
...
7. [JamesTurland/JimsGarage (1,605s/382f)](https://github.com/JamesTurland/JimsGarage) : Homelab Goodies
...
15. [1N3/Sn1per (7,832s/1,812f)](https://github.com/1N3/Sn1per) : Attack Surface Management Platform
...
18. [WhatsApp/proxy (1,343s/363f)](https://github.com/WhatsApp/proxy) : This repository contains the WhatsApp proxy implementation for users to host their own proxy infrastructure to connect to WhatsApp for chat (VoIP is not currently supported)

#### Markdown
1. [tldr-pages/tldr (49,786s/4,076f)](https://github.com/tldr-pages/tldr) : 📚 Collaborative cheatsheets for console commands
...
6. [drknzz/GitHub-Achievements (1,537s/154f)](https://github.com/drknzz/GitHub-Achievements) : 🔥 A Complete List of GitHub Profile Badges and Achievements 🔥
7. [mdn/translated-content (1,661s/8,010f)](https://github.com/mdn/translated-content) : The source repository of all translated content for MDN Web Docs
8. [microsoft/vscode-docs (5,585s/4,530f)](https://github.com/microsoft/vscode-docs) : Public documentation for Visual Studio Code
9. [jaywcjlove/linux-command (30,546s/5,941f)](https://github.com/jaywcjlove/linux-command) : Linux命令大全搜索工具，内容包含Linux命令手册、详解、学习、搜集。https://git.io/linux
10. [rust-lang/rfcs (5,824s/1,549f)](https://github.com/rust-lang/rfcs) : RFCs for changes to Rust
11. [satoshilabs/slips (1,476s/1,676f)](https://github.com/satoshilabs/slips) : SatoshiLabs Improvement Proposals
12. [ppy/osu-wiki (477s/1,056f)](https://github.com/ppy/osu-wiki) : home of the osu! wiki
13. [Evavic44/portfolio-ideas (3,972s/582f)](https://github.com/Evavic44/portfolio-ideas) : A curation of awesome portfolio website ideas for developers and designers to draw inspiration from. Raise a pull request to add more. 💜
14. [KaiserY/trpl-zh-cn (4,394s/575f)](https://github.com/KaiserY/trpl-zh-cn) : Rust 程序设计语言（2021 edition）
15. [labuladong/fucking-algorithm (124,528s/23,148f)](https://github.com/labuladong/fucking-algorithm) : 刷算法全靠套路，认准 labuladong 就够了！English version supported! Crack LeetCode, not only how, but also why.
16. [alexandresanlim/Badges4-README.md-Profile (10,110s/1,549f)](https://github.com/alexandresanlim/Badges4-README.md-Profile) : Improve your README.md profile with these amazing badges.
17. [privacyguides/privacyguides.org (2,614s/202f)](https://github.com/privacyguides/privacyguides.org) : Protect your data against global mass surveillance programs.
18. [adambard/learnxinyminutes-docs (11,329s/3,287f)](https://github.com/adambard/learnxinyminutes-docs) : Code documentation written as code! How novel and totally my idea!
19. [swiftlang/swift-evolution (15,270s/2,408f)](https://github.com/swiftlang/swift-evolution) : This maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
