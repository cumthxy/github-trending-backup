...
#### C
1. [ValdikSS/GoodbyeDPI (17,792s/1,379f)](https://github.com/ValdikSS/GoodbyeDPI) : GoodbyeDPI — Deep Packet Inspection circumvention utility (for Windows)
2. [bol-van/zapret (4,049s/415f)](https://github.com/bol-van/zapret) : DPI bypass multi platform
3. [asg017/sqlite-vec (2,371s/78f)](https://github.com/asg017/sqlite-vec) : A vector search SQLite extension that runs anywhere!
4. [hufrea/byedpi (534s/48f)](https://github.com/hufrea/byedpi) : Bypass DPI
...
17. [mpv-player/mpv (27,001s/2,847f)](https://github.com/mpv-player/mpv) : 🎥 Command line video player
...
#### Python
1. [comfyanonymous/ComfyUI (44,414s/4,717f)](https://github.com/comfyanonymous/ComfyUI) : The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
2. [yt-dlp/yt-dlp (78,744s/6,184f)](https://github.com/yt-dlp/yt-dlp) : A feature-rich command-line audio/video downloader
3. [zulip/zulip (20,778s/7,602f)](https://github.com/zulip/zulip) : Zulip server and web application. Open-source team chat that helps teams stay productive and focused.
4. [pytorch/torchchat (2,308s/160f)](https://github.com/pytorch/torchchat) : Run PyTorch LLMs locally on servers, desktop and mobile
...
6. [AUTOMATIC1111/stable-diffusion-webui (137,285s/26,134f)](https://github.com/AUTOMATIC1111/stable-diffusion-webui) : Stable Diffusion web UI
...
17. [donnemartin/system-design-primer (266,036s/45,073f)](https://github.com/donnemartin/system-design-primer) : Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
...
12. [Jondolf/avian (1,253s/103f)](https://github.com/Jondolf/avian) : ECS-driven 2D and 3D physics engine for the Bevy game engine.
...
6. [doocs/leetcode (30,198s/6,092f)](https://github.com/doocs/leetcode) : 🔥LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
...
9. [Netflix/maestro (2,678s/163f)](https://github.com/Netflix/maestro) : Maestro: Netflix’s Workflow Orchestrator
...
12. [iina/iina (37,329s/2,540f)](https://github.com/iina/iina) : The modern video player for macOS.
...
18. [WhatsApp/proxy (1,344s/363f)](https://github.com/WhatsApp/proxy) : This repository contains the WhatsApp proxy implementation for users to host their own proxy infrastructure to connect to WhatsApp for chat (VoIP is not currently supported)
...
#### Go
1. [xvzc/SpoofDPI (1,193s/73f)](https://github.com/xvzc/SpoofDPI) : A simple and fast anti-censorship tool written in Go
2. [pocketbase/pocketbase (37,545s/1,683f)](https://github.com/pocketbase/pocketbase) : Open Source realtime backend in 1 file
...
5. [wailsapp/wails (23,761s/1,135f)](https://github.com/wailsapp/wails) : Create beautiful applications using Go
...
11. [tailscale/tailscale (17,987s/1,385f)](https://github.com/tailscale/tailscale) : The easiest, most secure way to use WireGuard and 2FA.
...
4. [MatsuriDayo/NekoBoxForAndroid (10,136s/874f)](https://github.com/MatsuriDayo/NekoBoxForAndroid) : NekoBox for Android / sing-box / universal proxy toolchain for Android
...
8. [2dust/v2rayNG (33,415s/5,222f)](https://github.com/2dust/v2rayNG) : A V2Ray client for Android, support Xray core and v2fly core
9. [gedoor/legado (26,964s/3,684f)](https://github.com/gedoor/legado) : Legado 3.0 Book Reader with powerful controls & full functions❤️阅读3.0, 阅读是一款可以自定义来源阅读网络内容的工具，为广大网络文学爱好者提供一种方便、快捷舒适的试读体验。
...
5. [leaningtech/webvm (4,154s/659f)](https://github.com/leaningtech/webvm) : Virtual Machine for the Web
...
15. [cotes2020/jekyll-theme-chirpy (6,882s/5,523f)](https://github.com/cotes2020/jekyll-theme-chirpy) : A minimal, responsive, and feature-rich Jekyll theme for technical writing.
...
9. [RSSNext/follow (2,593s/70f)](https://github.com/RSSNext/follow) : 🧡 Next generation information browser
...
#### JavaScript
1. [SuhailTechInfo/Suhail-Md (4,735s/15,794f)](https://github.com/SuhailTechInfo/Suhail-Md) : meet Suhail-Md, Your All-in-One WhatsApp Excitement Buddy! Enjoy a thrilling messaging experience like never before. Suhail-Md brings a world of excitement and joy to your chats ✨🤖
...
14. [academicpages/academicpages.github.io (11,260s/40,640f)](https://github.com/academicpages/academicpages.github.io) : Github Pages template for academic personal websites, forked from mmistakes/minimal-mistakes
...
#### Vue
1. [vbenjs/vue-vben-admin (23,373s/6,383f)](https://github.com/vbenjs/vue-vben-admin) : A modern vue admin. It is based on Vue3、Shadcn UI、vite and TypeScript. It's fast！
...
10. [wanglin2/mind-map (5,003s/728f)](https://github.com/wanglin2/mind-map) : 一个还算强大的Web思维导图。A relatively powerful web mind map.
...
#### Markdown
1. [mdn/content (9,028s/22,434f)](https://github.com/mdn/content) : The content behind MDN Web Docs
2. [hetzneronline/community-content (275s/343f)](https://github.com/hetzneronline/community-content) : Hetzner Online Community Project
3. [mdn/translated-content (1,661s/8,010f)](https://github.com/mdn/translated-content) : The source repository of all translated content for MDN Web Docs
4. [microsoft/vscode-docs (5,585s/4,530f)](https://github.com/microsoft/vscode-docs) : Public documentation for Visual Studio Code
5. [jaywcjlove/linux-command (30,548s/5,941f)](https://github.com/jaywcjlove/linux-command) : Linux命令大全搜索工具，内容包含Linux命令手册、详解、学习、搜集。https://git.io/linux
6. [rust-lang/rfcs (5,824s/1,549f)](https://github.com/rust-lang/rfcs) : RFCs for changes to Rust
7. [Evavic44/portfolio-ideas (3,973s/582f)](https://github.com/Evavic44/portfolio-ideas) : A curation of awesome portfolio website ideas for developers and designers to draw inspiration from. Raise a pull request to add more. 💜
8. [labuladong/fucking-algorithm (124,528s/23,147f)](https://github.com/labuladong/fucking-algorithm) : 刷算法全靠套路，认准 labuladong 就够了！English version supported! Crack LeetCode, not only how, but also why.
9. [alexandresanlim/Badges4-README.md-Profile (10,110s/1,549f)](https://github.com/alexandresanlim/Badges4-README.md-Profile) : Improve your README.md profile with these amazing badges.
10. [privacyguides/privacyguides.org (2,614s/202f)](https://github.com/privacyguides/privacyguides.org) : Protect your data against global mass surveillance programs.
11. [adambard/learnxinyminutes-docs (11,329s/3,287f)](https://github.com/adambard/learnxinyminutes-docs) : Code documentation written as code! How novel and totally my idea!
12. [swiftlang/swift-evolution (15,270s/2,408f)](https://github.com/swiftlang/swift-evolution) : This maintains proposals for changes and user-visible enhancements to the Swift Programming Language.

#### Ruby
1. [rapid7/metasploit-framework (33,488s/13,836f)](https://github.com/rapid7/metasploit-framework) : Metasploit Framework
2. [Homebrew/homebrew-cask (20,733s/10,614f)](https://github.com/Homebrew/homebrew-cask) : 🍻 A CLI workflow for the administration of macOS applications distributed as binaries
...
9. [cloudfoundry/routing-release (42s/107f)](https://github.com/cloudfoundry/routing-release) : This is the BOSH release for cloud foundry routers
